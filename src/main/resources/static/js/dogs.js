...
document.getElementById("btn-add-dog").addEventListener("click", () => show(document.getElementById("add-dog-modal")));
...
const dogCreateReq = (params) => fetch(`${API_URL_BASE}/dogs`, {
    method: "POST",
...
const deleteDogReq = (id) => fetch(`${API_URL_BASE}/dogs/${id}`, {
    method: "DELETE",
});
